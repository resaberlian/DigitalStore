...
<head>
 ...
 <body id="Digital" class="dashboard">
      <!-- start: Header -->
          ...
          <div class="col-md-12 nav-wrapper">
            <div class="navbar-header" style="width:100%;">
              ...
              <ul class="nav navbar-nav navbar-right user-nav">
                <li class="user-name"><span><?=$this->session->userdata('nama_user')?></span></li>
                  <li class="dropdown avatar-dropdown">
                   ...
                   <ul class="dropdown-menu user-dropdown">
                     ...
                     <li><a href="<?=base_url('index.php/Login/logout')?>"><span class="fa fa-key"></span> Log out</a></li>
                ...
                <li ><a href="#" class="opener-right-menu"><span class="fa-camera fa"></span></a></li>
              </ul>
            </div>
          </div>
        </nav>
            ...
            <div id="left-menu">
              <div class="sub-left-menu scroll">
                <ul class="nav nav-list">
                    ...
                    <li><a href="<?= base_url() ?>index.php/Dashboard" class="active"><i class="fa-home fa"></i> <span>Dashboard</span></a></li>
					<li><a href="<?= base_url() ?>index.php/Kamera" class="active"><i class="fa-camera fa"></i> <span>Kamera</span></a></li>
					<li><a href="<?= base_url() ?>index.php/Kategori" class="active"><i class="fa-list fa "></i> <span>Kategori</span></a></li>
					<li><a href="<?= base_url() ?>index.php/Histori" class="active"><i class="fa-history fa "></i> <span>Histori</span></a></li>
						<?php if($this->session->userdata('level')=="kasir"){?>
						<li><a href="<?= base_url() ?>index.php/Transaksi" class="active"><i class="fa-credit-card fa"></i> <span>Transaksi</span></a></li>
						<?php }?>
						<?php if($this->session->userdata('level')=="admin"){?>
						<li><a href="<?= base_url() ?>index.php/Kasir" class="active"><i class="fa-user fa "></i> <span>pegawai</span></a></li>
						<?php }?>
				</div>
	</div>  
